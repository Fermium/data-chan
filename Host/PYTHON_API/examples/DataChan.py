...
def datachan_device_release(dev):
    return _DataChan.datachan_device_release(dev)
datachan_device_release = _DataChan.datachan_device_release

def datachan_device_enable(dev):
    return _DataChan.datachan_device_enable(dev)
datachan_device_enable = _DataChan.datachan_device_enable

def datachan_device_is_enabled(dev):
    return _DataChan.datachan_device_is_enabled(dev)
datachan_device_is_enabled = _DataChan.datachan_device_is_enabled

def datachan_device_disable(dev):
    return _DataChan.datachan_device_disable(dev)
